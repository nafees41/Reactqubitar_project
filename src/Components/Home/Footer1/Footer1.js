          ...
          <div className="col-md-3">
            <div className="list">
              ...
              <NavHashLink to="/ui_ux_design">
                {" "}
                <div className="list-items mt-5">UI/UX Design</div>
              </NavHashLink>
              ...
              <NavHashLink to="/nft">
                {" "}
                <div className="list-items">NFT Development</div>
              </NavHashLink>
          ...
          <div className="col-md-3">
            <div className="list">
              ...
              <NavHashLink to="/#home_banner">
                {" "}
                <div className="list-items mt-5">Home</div>
              </NavHashLink>
              ...
              <NavHashLink to="/#services">
                {" "}
                <div className="list-items">Services</div>
              </NavHashLink>
              <NavHashLink to="/">
                {" "}
                <div className="list-items">Career</div>
              </NavHashLink>
              <NavHashLink to="/blog">
                <div className="list-items">Blogs</div>
              </NavHashLink>
            </div>
          </div>
          <div className="col-md-3">
            <div className="list">
              ...
              <div className="list-items  mt-5 phone  ">
                ...
                <a href="tel:+923026469153" target="_blank">
                  {" "}
                  <div className="phone-desc dd_desk">+92 302 6469153</div>
                </a>
              </div>
              <div className="list-items email mt-5">
                <img src={email} className="image-fluid" alt="switch" />
                <a href="mailto:info@qubitars.com">
                  {" "}
                  <div className="email-desc dd_desk">info@qubitars.com</div>
                </a>
              </div>
              <div className="list-items location mt-5">
                <img src={location} className="image-fluid" alt="switch" />
                <div className="location-desc dd_desk">
